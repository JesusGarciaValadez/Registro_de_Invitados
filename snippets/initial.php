<?php
	...
	// Body Query
	$principalQuery    = "CREATE TABLE IF NOT EXISTS `u213243_queryTestIntranet`.`persona` (
...
CREATE TABLE IF NOT EXISTS `u213243_queryTestIntranet`.`metadata` (
...
CREATE TABLE IF NOT EXISTS `u213243_queryTestIntranet`.`comision` (
...
INSERT INTO `u213243_queryTestIntranet`.`metadata` (
    `id_metadata` ,
    `genero` , 
    `tipo_vendedor` 
)
...
INSERT INTO `u213243_queryTestIntranet`.`cargo` (
    `id_cargo` ,
    `cargo`
)
VALUES (
...
INSERT INTO `u213243_queryTestIntranet`.`eleccion` (
    `id_eleccion` ,
    `eleccion`
)
VALUES (
...
INSERT INTO `u213243_queryTestIntranet`.`circu` (
    `id_circu` ,
    `circu`
)
VALUES (
...
INSERT INTO `u213243_queryTestIntranet`.`estado` (
    `id_estado` ,
    `estado`
)
VALUES 
...
INSERT INTO `u213243_queryTestIntranet`.`comision` (
    `id_comision` ,
    `comision`
)
VALUES (
...
INSERT INTO `u213243_queryTestIntranet`.`area` (
    `id_area` ,
    `area`
)
VALUES (
